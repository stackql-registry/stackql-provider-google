--- 
title: reasoning_engines_iam_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - reasoning_engines_iam_policies
  - aiplatform
  - google
...
Creates, updates, deletes, gets or lists a <code>reasoning_engines_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="reasoning_engines_iam_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.aiplatform.reasoning_engines_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.aiplatform.reasoning_engines_iam_policies
...
```sql
REPLACE google.aiplatform.reasoning_engines_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
```sql
EXEC google.aiplatform.reasoning_engines_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
