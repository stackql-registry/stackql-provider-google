...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="datasets_iam_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.aiplatform.datasets_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.aiplatform.datasets_iam_policies
...
```sql
REPLACE google.aiplatform.datasets_iam_policies
SET 
data__policy = '{{ policy }}'
WHERE 
...
```sql
EXEC google.aiplatform.datasets_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
