...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="tables_iam_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.biglake.tables_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-catalogsId"><code>catalogsId</code></a>, <a href="#parameter-namespacesId"><code>namespacesId</code></a>, <a href="#parameter-tablesId"><code>tablesId</code></a></td>
    <td><a href="#parameter-options.requestedPolicyVersion"><code>options.requestedPolicyVersion</code></a></td>
    <td>Gets the IAM policy for the specified Catalog.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-catalogsId"><code>catalogsId</code></a>, <a href="#parameter-namespacesId"><code>namespacesId</code></a>, <a href="#parameter-tablesId"><code>tablesId</code></a></td>
    <td></td>
    <td>Tests the IAM permissions for the specified table.</td>
</tr>
</tbody>
</table>
...
members,
role
FROM google.biglake.tables_iam_policies
...
```sql
REPLACE google.biglake.tables_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.biglake.tables_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
