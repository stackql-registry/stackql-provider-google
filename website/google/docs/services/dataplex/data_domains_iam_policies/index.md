--- 
title: data_domains_iam_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - data_domains_iam_policies
  - dataplex
  - google
...
Creates, updates, deletes, gets or lists a <code>data_domains_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="data_domains_iam_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.dataplex.data_domains_iam_policies" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="projects_locations_data_domains_get_iam_policy"
    values={[
        { label: 'projects_locations_data_domains_get_iam_policy', value: 'projects_locations_data_domains_get_iam_policy' }
    ]}
>
<TabItem value="projects_locations_data_domains_get_iam_policy">
...
<tbody>
<tr>
    <td><a href="#projects_locations_data_domains_get_iam_policy"><CopyableCode code="projects_locations_data_domains_get_iam_policy" /></a></td>
...
<tr>
    <td><a href="#projects_locations_data_domains_set_iam_policy"><CopyableCode code="projects_locations_data_domains_set_iam_policy" /></a></td>
...
<tr>
    <td><a href="#projects_locations_data_domains_test_iam_permissions"><CopyableCode code="projects_locations_data_domains_test_iam_permissions" /></a></td>
...
members,
role
FROM google.dataplex.data_domains_iam_policies
...
<Tabs
    defaultValue="projects_locations_data_domains_set_iam_policy"
    values={[
        { label: 'projects_locations_data_domains_set_iam_policy', value: 'projects_locations_data_domains_set_iam_policy' }
    ]}
>
<TabItem value="projects_locations_data_domains_set_iam_policy">

Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors.

```sql
REPLACE google.dataplex.data_domains_iam_policies
SET 
data__policy = '{{ policy }}',
...
<Tabs
    defaultValue="projects_locations_data_domains_test_iam_permissions"
    values={[
        { label: 'projects_locations_data_domains_test_iam_permissions', value: 'projects_locations_data_domains_test_iam_permissions' }
    ]}
>
<TabItem value="projects_locations_data_domains_test_iam_permissions">

Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a NOT_FOUND error.Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning.

```sql
EXEC google.dataplex.data_domains_iam_policies.projects_locations_data_domains_test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@dataDomainsId='{{ dataDomainsId }}' --required 
@@json=
'{
