...
<Tabs
    defaultValue="projects_locations_collections_engines_sessions_get"
    values={[
...
<Tabs
    defaultValue="projects_locations_collections_engines_sessions_create"
    values={[
...
<Tabs
    defaultValue="projects_locations_collections_engines_sessions_patch"
    values={[
...
<Tabs
    defaultValue="projects_locations_collections_engines_sessions_delete"
    values={[
