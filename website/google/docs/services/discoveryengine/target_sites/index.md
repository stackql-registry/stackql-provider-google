...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="target_sites" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Output only. Indexing status. (INDEXING_STATUS_UNSPECIFIED, PENDING, FAILED, SUCCEEDED, DELETING, CANCELLABLE, CANCELLED)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The type of the target site, e.g., whether the site is to be included or excluded. (TYPE_UNSPECIFIED, INCLUDE, EXCLUDE)</td>
</tr>
<tr>
...
<Tabs
    defaultValue="projects_locations_collections_data_stores_site_search_engine_target_sites_batch_create"
    values={[
