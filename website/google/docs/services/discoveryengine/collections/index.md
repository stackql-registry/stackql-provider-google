...
<tr><td><b>Id</b></td><td><CopyableCode code="google.discoveryengine.collections" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#projects_locations_collections_delete"><CopyableCode code="projects_locations_collections_delete" /></a></td>
...
<Tabs
    defaultValue="projects_locations_collections_delete"
    values={[
        { label: 'projects_locations_collections_delete', value: 'projects_locations_collections_delete' }
    ]}
>
<TabItem value="projects_locations_collections_delete">
