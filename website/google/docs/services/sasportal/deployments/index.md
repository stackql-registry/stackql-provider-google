...
<Tabs
    defaultValue="nodes_nodes_deployments_list"
    values={[
...
<Tabs
    defaultValue="nodes_nodes_deployments_create"
    values={[
...
<Tabs
    defaultValue="nodes_deployments_patch"
    values={[
...
<Tabs
    defaultValue="nodes_deployments_delete"
    values={[
...
<Tabs
    defaultValue="nodes_deployments_move"
    values={[
