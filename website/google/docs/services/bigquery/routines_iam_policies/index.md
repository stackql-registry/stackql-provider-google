...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="routines_iam_policies" /></td></tr>
...
members,
role
FROM google.bigquery.routines_iam_policies
...
```sql
EXEC google.bigquery.routines_iam_policies.test_iam_permissions 
@resource='{{ resource }}' --required 
@@json=
'{
