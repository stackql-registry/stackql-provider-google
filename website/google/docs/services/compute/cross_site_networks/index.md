...
Creates, updates, deletes, gets or lists a <code>cross_site_networks</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="cross_site_networks" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.compute.cross_site_networks" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>An optional description of the cross-site network.</td>
</tr>
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
    <td>Output only. [Output Only] Type of the resource. Alwayscompute#crossSiteNetwork for cross-site networks. (default: compute#crossSiteNetwork)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>A list of CrossSiteNetwork resources.</td>
</tr>
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
...
<tr>
    ...
    <td></td>
    <td>Returns the specified cross-site network in the given scope.</td>
</tr>
<tr>
    ...
    <td>Lists the cross-site networks for a project in the given scope.</td>
</tr>
<tr>
    ...
    <td>Creates a cross-site network in the specified project in the given scope<br />using the parameters that are included in the request.</td>
</tr>
<tr>
    ...
    <td>Updates the specified cross-site network with the data included in<br />the request. This method supportsPATCH<br />semantics and uses theJSON merge<br />patch format and processing rules.</td>
</tr>
<tr>
    ...
    <td>Deletes the specified cross-site network in the given scope.</td>
</tr>
</tbody>
</table>
...
Creates a cross-site network in the specified project in the given scope<br />using the parameters that are included in the request.
...
- name: cross_site_networks
  props:
    - name: project
      value: "{{ project }}"
      description: Required parameter for the cross_site_networks resource.
    - name: description
      value: "{{ description }}"
      description: |
...
Updates the specified cross-site network with the data included in<br />the request. This method supportsPATCH<br />semantics and uses theJSON merge<br />patch format and processing rules.
