...
<tr>
    ...
    <td><code>object</code></td>
    <td>Input only. [Input Only] Additional params passed with the request, but not persisted as part of resource payload. (id: VpnGatewayParams)</td>
</tr>
<tr>
    <td><CopyableCode code="region" /></td>
    <td><code>string</code></td>
    <td>Output only. [Output Only] URL of the region where the VPN gateway resides.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The stack type for this VPN gateway to identify the IP protocols that are enabled. Possible values are: IPV4_ONLY,IPV4_IPV6, IPV6_ONLY. If not specified,IPV4_ONLY is used if the gateway IP version isIPV4, or IPV4_IPV6 if the gateway IP version isIPV6. (IPV4_IPV6, IPV4_ONLY, IPV6_ONLY)</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
    <td>Output only. [Output Only] Type of resource. Always compute#vpnGateway for VPN gateways. (default: compute#vpnGatewayList)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Creates a VPN gateway in the specified project and region using<br />the data included in the request.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-requestId"><code>requestId</code></a></td>
    <td>Sets the labels on a VpnGateway. To learn more about labels, read theLabeling<br />Resources documentation.</td>
</tr>
</tbody>
</table>
...
Retrieves a list of VPN gateways available to the specified<br />project and region.
...
Retrieves an aggregated list of VPN gateways.<br /><br />To prevent failure, Google recommends that you set the<br />`returnPartialSuccess` parameter to `true`.
...
Creates a VPN gateway in the specified project and region using<br />the data included in the request.
...
Sets the labels on a VpnGateway. To learn more about labels, read theLabeling<br />Resources documentation.
