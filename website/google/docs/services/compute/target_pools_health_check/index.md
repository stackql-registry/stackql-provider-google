...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="target_pools_health_check" /></td></tr>
...
<tr>
    ...
    <td>Output only. [Output Only] Type of resource. Alwayscompute#targetPoolInstanceHealth when checking the health of an instance. (default: compute#targetPoolInstanceHealth)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Gets the most recent health check results for each IP for the<br />instance that is referenced by the given target pool.</td>
</tr>
<tr>
...
Gets the most recent health check results for each IP for the<br />instance that is referenced by the given target pool.
