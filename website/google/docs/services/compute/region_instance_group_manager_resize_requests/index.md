--- 
title: region_instance_group_manager_resize_requests
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>region_instance_group_manager_resize_requests</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="region_instance_group_manager_resize_requests" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.compute.region_instance_group_manager_resize_requests" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
    <td>Output only. Type of the resource. Alwayscompute#regionInstanceGroupManagerResizeRequestList for a list of Resize Requests. (default: compute#regionInstanceGroupManagerResizeRequestList)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-project"><code>project</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-instanceGroupManager"><code>instanceGroupManager</code></a>, <a href="#parameter-resizeRequest"><code>resizeRequest</code></a></td>
    <td></td>
...
<tr>
    ...
    <td><a href="#parameter-project"><code>project</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-instanceGroupManager"><code>instanceGroupManager</code></a>, <a href="#parameter-resizeRequest"><code>resizeRequest</code></a></td>
    <td><a href="#parameter-requestId"><code>requestId</code></a></td>
    <td>Cancels the specified resize request.<br />Cancelled resize request no longer waits for the resources to be<br />provisioned. Cancel is only possible for requests that are in accepted<br />state.</td>
</tr>
</tbody>
</table>
...
Cancels the specified resize request.<br />Cancelled resize request no longer waits for the resources to be<br />provisioned. Cancel is only possible for requests that are in accepted<br />state.
