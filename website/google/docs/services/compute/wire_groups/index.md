...
Creates, updates, deletes, gets or lists a <code>wire_groups</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="wire_groups" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.compute.wire_groups" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Indicates whether the wires in the wire group are enabled. When false, the wires in the wire group are disabled. When true and when there is simultaneously no wire-specific override of `adminEnabled` to false, a given wire is enabled. Defaults to true.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>An optional description of the wire group.</td>
</tr>
<tr>
    <td><CopyableCode code="endpoints" /></td>
    <td><code>object</code></td>
    <td>A map that contains the logical endpoints of the wire group. Specify key-value pairs for the map as follows:        - Key: an RFC1035 user-specified label.    - Value: an Endpoint object.</td>
</tr>
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
    <td>Output only. [Output Only] Type of the resource. Alwayscompute#wireGroups for wire groups. (default: compute#wireGroup)</td>
</tr>
<tr>
    <td><CopyableCode code="reconciling" /></td>
    <td><code>boolean</code></td>
    <td>Output only. [Output Only] Indicates whether there are wire changes yet to be processed.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="topology" /></td>
    <td><code>object</code></td>
    <td>Output only. Topology details for the wire group configuration. (id: WireGroupTopology)</td>
</tr>
<tr>
    <td><CopyableCode code="wireProperties" /></td>
    <td><code>object</code></td>
    <td>Properties for all wires in the wire group. (id: WireProperties)</td>
</tr>
<tr>
    <td><CopyableCode code="wires" /></td>
    <td><code>array</code></td>
    <td>Output only. The single/redundant wire(s) managed by the wire group.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><code>array</code></td>
    <td>A list of wire group resources.</td>
</tr>
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
...
<tr>
    ...
    <td><a href="#parameter-project"><code>project</code></a>, <a href="#parameter-crossSiteNetwork"><code>crossSiteNetwork</code></a>, <a href="#parameter-wireGroup"><code>wireGroup</code></a></td>
    <td></td>
    <td>Gets the specified wire group resource in the given scope.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Creates a wire group in the specified project in the given scope<br />using the parameters that are included in the request.</td>
</tr>
<tr>
    ...
    <td>Updates the specified wire group resource with the data included in the<br />request. This method supportsPATCH<br />semantics and usesJSON merge<br />patch format and processing rules.</td>
</tr>
<tr>
    ...
    <td>Deletes the specified wire group in the given scope.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-crossSiteNetwork">
    <td><CopyableCode code="crossSiteNetwork" /></td>
    <td><code>string</code></td>
    <td></td>
</tr>
...
<tr id="parameter-wireGroup">
    <td><CopyableCode code="wireGroup" /></td>
    <td><code>string</code></td>
    <td></td>
</tr>
...
Creates a wire group in the specified project in the given scope<br />using the parameters that are included in the request.
...
- name: wire_groups
  props:
    - name: project
      value: "{{ project }}"
      description: Required parameter for the wire_groups resource.
...
Updates the specified wire group resource with the data included in the<br />request. This method supportsPATCH<br />semantics and usesJSON merge<br />patch format and processing rules.
