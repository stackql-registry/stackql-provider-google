...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="storage_pool_types" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Output only. [Output Only] Type of the resource. Alwayscompute#storagePoolType for storage pool types. (default: compute#storagePoolType)</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
    <td>Output only. [Output Only] Type of resource. Alwayscompute#storagePoolTypeList for storage pool types. (default: compute#storagePoolTypeList)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Retrieves a list of storage pool types available to the specified<br />project.</td>
</tr>
<tr>
    ...
    <td>Retrieves an aggregated list of storage pool types.<br /><br />To prevent failure, Google recommends that you set the<br />`returnPartialSuccess` parameter to `true`.</td>
</tr>
</tbody>
</table>
...
Retrieves a list of storage pool types available to the specified<br />project.
...
Retrieves an aggregated list of storage pool types.<br /><br />To prevent failure, Google recommends that you set the<br />`returnPartialSuccess` parameter to `true`.
