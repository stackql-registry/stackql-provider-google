--- 
title: reservation_blocks_iam_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - reservation_blocks_iam_policies
  - compute
  - google
...
Creates, updates, deletes, gets or lists a <code>reservation_blocks_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="reservation_blocks_iam_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.compute.reservation_blocks_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-project"><code>project</code></a>, <a href="#parameter-zone"><code>zone</code></a>, <a href="#parameter-parentResource"><code>parentResource</code></a>, <a href="#parameter-resource"><code>resource</code></a></td>
...
members,
role
FROM google.compute.reservation_blocks_iam_policies
...
```sql
REPLACE google.compute.reservation_blocks_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.compute.reservation_blocks_iam_policies.test_iam_permissions 
@project='{{ project }}' --required, 
@zone='{{ zone }}' --required, 
