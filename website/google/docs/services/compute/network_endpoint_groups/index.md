...
<tr>
    ...
    <td>Retrieves the list of network endpoint groups that are located in the<br />specified project.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-project"><code>project</code></a>, <a href="#parameter-networkEndpointGroup"><code>networkEndpointGroup</code></a></td>
    <td><a href="#parameter-requestId"><code>requestId</code></a></td>
    <td>Deletes the specified network endpoint group.Note that the NEG cannot be<br />deleted if there are backend services referencing it.</td>
</tr>
<tr>
...
Retrieves the list of network endpoint groups that are located in the<br />specified project.
...
Deletes the specified network endpoint group.Note that the NEG cannot be<br />deleted if there are backend services referencing it.
