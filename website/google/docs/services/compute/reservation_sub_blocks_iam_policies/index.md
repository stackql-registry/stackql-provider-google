--- 
title: reservation_sub_blocks_iam_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - reservation_sub_blocks_iam_policies
  - compute
  - google
...
Creates, updates, deletes, gets or lists a <code>reservation_sub_blocks_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="reservation_sub_blocks_iam_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.compute.reservation_sub_blocks_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-project"><code>project</code></a>, <a href="#parameter-zone"><code>zone</code></a>, <a href="#parameter-reservationsId"><code>reservationsId</code></a>, <a href="#parameter-reservationBlocksId"><code>reservationBlocksId</code></a>, <a href="#parameter-resource"><code>resource</code></a></td>
...
Gets the access control policy for a resource. May be empty if no such<br />policy or resource exists.
...
members,
role
FROM google.compute.reservation_sub_blocks_iam_policies
...
Sets the access control policy on the specified resource.<br />Replaces any existing policy.
...
```sql
EXEC google.compute.reservation_sub_blocks_iam_policies.test_iam_permissions 
@project='{{ project }}' --required, 
@zone='{{ zone }}' --required, 
