...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="vpn_tunnels" /></td></tr>
...
<tr>
    <td><CopyableCode code="cipherSuite" /></td>
    <td><code>object</code></td>
    <td>User specified list of ciphers to use for the phase 1 and phase 2 of the IKE protocol. (id: VpnTunnelCipherSuite)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>Input only. [Input Only] Additional params passed with the request, but not persisted as part of resource payload. (id: VpnTunnelParams)</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
    <td>Output only. [Output Only] Type of resource. Always compute#vpnTunnel for VPN tunnels. (default: compute#vpnTunnelList)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Creates a VpnTunnel resource in the specified project and region using<br />the data included in the request.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-requestId"><code>requestId</code></a></td>
    <td>Sets the labels on a VpnTunnel. To learn more about labels, read theLabeling<br />Resources documentation.</td>
</tr>
</tbody>
</table>
...
Retrieves a list of VpnTunnel resources contained in the specified<br />project and region.
...
Retrieves an aggregated list of VPN tunnels.<br /><br />To prevent failure, Google recommends that you set the<br />`returnPartialSuccess` parameter to `true`.
...
Creates a VpnTunnel resource in the specified project and region using<br />the data included in the request.
...
Sets the labels on a VpnTunnel. To learn more about labels, read theLabeling<br />Resources documentation.
