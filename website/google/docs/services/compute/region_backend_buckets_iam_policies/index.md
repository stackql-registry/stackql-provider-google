--- 
title: region_backend_buckets_iam_policies
hide_title: false
hide_table_of_contents: false
keywords:
  - region_backend_buckets_iam_policies
  - compute
  - google
...
Creates, updates, deletes, gets or lists a <code>region_backend_buckets_iam_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="region_backend_buckets_iam_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.compute.region_backend_buckets_iam_policies" /></td></tr>
</tbody></table>
...
members,
role
FROM google.compute.region_backend_buckets_iam_policies
...
```sql
REPLACE google.compute.region_backend_buckets_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.compute.region_backend_buckets_iam_policies.test_iam_permissions 
@project='{{ project }}' --required, 
