...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="target_vpn_gateways" /></td></tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>Input only. [Input Only] Additional params passed with the request, but not persisted as part of resource payload. (id: TargetVpnGatewayParams)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>[Output Only] The status of the VPN gateway, which can be one of the following: CREATING, READY, FAILED, or DELETING. (CREATING, DELETING, FAILED, READY)</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="kind" /></td>
    <td><code>string</code></td>
    <td>Output only. [Output Only] Type of resource. Alwayscompute#targetVpnGateway for target VPN gateways. (default: compute#targetVpnGatewayList)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Creates a target VPN gateway in the specified project and region using<br />the data included in the request.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-requestId"><code>requestId</code></a></td>
    <td>Sets the labels on a TargetVpnGateway. To learn more about labels, read theLabeling<br />Resources documentation.</td>
</tr>
</tbody>
</table>
...
Retrieves a list of target VPN gateways available to the specified<br />project and region.
...
Retrieves an aggregated list of target VPN gateways.<br /><br />To prevent failure, Google recommends that you set the<br />`returnPartialSuccess` parameter to `true`.
...
Creates a target VPN gateway in the specified project and region using<br />the data included in the request.
...
Sets the labels on a TargetVpnGateway. To learn more about labels, read theLabeling<br />Resources documentation.
