...
<tr>
    <td><CopyableCode code="databaseCenterIntegrationEnabled" /></td>
    <td><code>boolean</code></td>
    <td>Optional. If true, instance metadata is sent to the Database Center. If false, instance metadata is not sent to the Database Center.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-project"><code>project</code></a>, <a href="#parameter-instance"><code>instance</code></a></td>
    <td><a href="#parameter-reconcilePscNetworking"><code>reconcilePscNetworking</code></a>, <a href="#parameter-reconcilePscNetworkingForce"><code>reconcilePscNetworkingForce</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-project"><code>project</code></a>, <a href="#parameter-instance"><code>instance</code></a></td>
    <td><a href="#parameter-enableFinalBackup"><code>enableFinalBackup</code></a>, <a href="#parameter-finalBackupDescription"><code>finalBackupDescription</code></a>, <a href="#parameter-finalBackupExpiryTime"><code>finalBackupExpiryTime</code></a>, <a href="#parameter-finalBackupTtlDays"><code>finalBackupTtlDays</code></a></td>
...
data__databaseCenterIntegrationEnabled,
...
- name: instances
  props:
    ...
    - name: databaseCenterIntegrationEnabled
      value: {{ databaseCenterIntegrationEnabled }}
      description: |
...
data__databaseCenterIntegrationEnabled = {{ databaseCenterIntegrationEnabled }},
...
<Tabs
    defaultValue="acquire_ssrs_lease"
    values={[
