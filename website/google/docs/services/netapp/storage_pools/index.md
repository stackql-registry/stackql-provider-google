...
<tr>
    <td><CopyableCode code="coldTierSizeUsedGib" /></td>
    <td><code>string (int64)</code></td>
    <td>Output only. Total cold tier data rounded down to the nearest GiB used by the storage pool.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Output only. Specifies the current pool encryption key source. (ENCRYPTION_TYPE_UNSPECIFIED, SERVICE_MANAGED, CLOUD_KMS)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string (int64)</code></td>
    <td>Output only. Total hot tier data rounded down to the nearest GiB used by the storage pool.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Optional. Mode of the storage pool. This field is used to control whether the user can perform ONTAP operations on the storage pool using the GCNV ONTAP Mode APIs. If not specified during creation, it defaults to `DEFAULT`. (MODE_UNSPECIFIED, DEFAULT, ONTAP)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Optional. QoS (Quality of Service) Type of the storage pool (QOS_TYPE_UNSPECIFIED, AUTO, MANUAL)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Optional. The scale type of the storage pool. Defaults to `SCALE_TYPE_DEFAULT` if not specified. (SCALE_TYPE_UNSPECIFIED, SCALE_TYPE_DEFAULT, SCALE_TYPE_SCALEOUT)</td>
</tr>
<tr>
    <td><CopyableCode code="serviceLevel" /></td>
    <td><code>string</code></td>
    <td>Required. Service level of the storage pool (SERVICE_LEVEL_UNSPECIFIED, PREMIUM, EXTREME, STANDARD, FLEX)</td>
</tr>
<tr>
    <td><CopyableCode code="state" /></td>
    <td><code>string</code></td>
    <td>Output only. State of the storage pool (STATE_UNSPECIFIED, READY, CREATING, DELETING, UPDATING, RESTORING, DISABLED, ERROR)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Optional. Type of the storage pool. This field is used to control whether the pool supports `FILE` based volumes only or `UNIFIED` (both `FILE` and `BLOCK`) volumes. If not specified during creation, it defaults to `FILE`. (STORAGE_POOL_TYPE_UNSPECIFIED, FILE, UNIFIED)</td>
</tr>
<tr>
...
- name: storage_pools
  props:
    ...
    - name: scaleType
      ...
      valid_values: ['SCALE_TYPE_UNSPECIFIED', 'SCALE_TYPE_DEFAULT', 'SCALE_TYPE_SCALEOUT']
    - name: serviceLevel
      value: "{{ serviceLevel }}"
      description: |
