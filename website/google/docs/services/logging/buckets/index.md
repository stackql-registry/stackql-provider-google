...
<Tabs
    defaultValue="billing_accounts_locations_buckets_get"
    values={[
...
<Tabs
    defaultValue="billing_accounts_locations_buckets_create"
    values={[
...
<Tabs
    defaultValue="billing_accounts_locations_buckets_patch"
    values={[
...
<Tabs
    defaultValue="billing_accounts_locations_buckets_delete"
    values={[
