...
<Tabs
    defaultValue="organizations_locations_buckets_get"
    values={[
...
<Tabs
    defaultValue="organizations_locations_buckets_create"
    values={[
...
<Tabs
    defaultValue="organizations_locations_buckets_patch"
    values={[
...
<Tabs
    defaultValue="organizations_locations_buckets_delete"
    values={[
...
<Tabs
    defaultValue="organizations_locations_buckets_undelete"
    values={[
