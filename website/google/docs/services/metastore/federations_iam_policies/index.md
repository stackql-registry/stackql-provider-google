...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="federations_iam_policies" /></td></tr>
...
```sql
EXEC google.metastore.federations_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@federationsId='{{ federationsId }}' --required 
@@json=
'{
