...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="vpcsc_config" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The project per location VPC SC policy that defines the VPC SC behavior for the Remote Repository (Allow/Deny). (VPCSC_POLICY_UNSPECIFIED, DENY, ALLOW)</td>
</tr>
</tbody>
</table>
</TabItem>
