...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="spark_applications" /></td></tr>
...
<tr id="parameter-semanticQueryId">
    <td><CopyableCode code="semanticQueryId" /></td>
    <td><code>string</code></td>
    <td></td>
</tr>
...
<TabItem value="projects_locations_batches_spark_applications_access_native_sql_query">

Obtain data corresponding to a particular Native SQL Query for a Spark Application.

```sql
EXEC google.dataproc.spark_applications.projects_locations_batches_spark_applications_access_native_sql_query 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@batchesId='{{ batchesId }}' --required, 
@sparkApplicationsId='{{ sparkApplicationsId }}' --required, 
...
<TabItem value="projects_locations_batches_spark_applications_compute_tuning_config">

Returns autotuning configuration for a specific query plan id and cohort id. Called by Spark during query planning.

```sql
EXEC google.dataproc.spark_applications.projects_locations_batches_spark_applications_compute_tuning_config 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@batchesId='{{ batchesId }}' --required, 
@sparkApplicationsId='{{ sparkApplicationsId }}' --required, 
@executionId='{{ executionId }}', 
@parent='{{ parent }}', 
@semanticQueryId='{{ semanticQueryId }}'
;
```
</TabItem>
