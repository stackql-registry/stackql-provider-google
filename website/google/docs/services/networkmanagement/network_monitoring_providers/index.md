...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="network_monitoring_providers" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Required. Type of the NetworkMonitoringProvider. (PROVIDER_TYPE_UNSPECIFIED, EXTERNAL)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Output only. State of the NetworkMonitoringProvider. (STATE_UNSPECIFIED, ACTIVATING, ACTIVE, SUSPENDING, SUSPENDED, DELETING, DELETED)</td>
</tr>
<tr>
...
<tr>
    <td><a href="#generate_monitoring_point_config"><CopyableCode code="generate_monitoring_point_config" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-networkMonitoringProvidersId"><code>networkMonitoringProvidersId</code></a></td>
    <td><a href="#parameter-privateConnectivityEnabled"><code>privateConnectivityEnabled</code></a></td>
    <td>Generates Monitoring Point configuration of a NetworkMonitoringProvider resource.</td>
</tr>
<tr>
    <td><a href="#generate_provider_access_token"><CopyableCode code="generate_provider_access_token" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-networkMonitoringProvidersId"><code>networkMonitoringProvidersId</code></a></td>
    <td><a href="#parameter-gcpAccessToken"><code>gcpAccessToken</code></a></td>
    <td>Generates a provider access token for a given Google access token. Provider access token is a short-lived token that is used to access resources in the provider's platform.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-gcpAccessToken">
    <td><CopyableCode code="gcpAccessToken" /></td>
    <td><code>string</code></td>
    <td></td>
</tr>
...
- name: network_monitoring_providers
  props:
    ...
    - name: networkMonitoringProviderId
      value: "{{ networkMonitoringProviderId }}"
`}</CodeBlock>
...
<Tabs
    defaultValue="generate_monitoring_point_config"
    values={[
        { label: 'generate_monitoring_point_config', value: 'generate_monitoring_point_config' },
        { label: 'generate_provider_access_token', value: 'generate_provider_access_token' }
    ]}
>
<TabItem value="generate_monitoring_point_config">

Generates Monitoring Point configuration of a NetworkMonitoringProvider resource.

```sql
EXEC google.networkmanagement.network_monitoring_providers.generate_monitoring_point_config 
...
<TabItem value="generate_provider_access_token">
...
```sql
EXEC google.networkmanagement.network_monitoring_providers.generate_provider_access_token 
@projectsId='{{ projectsId }}' --required, 
@locationsId='{{ locationsId }}' --required, 
@networkMonitoringProvidersId='{{ networkMonitoringProvidersId }}' --required, 
