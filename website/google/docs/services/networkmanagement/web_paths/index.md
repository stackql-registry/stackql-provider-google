...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="web_paths" /></td></tr>
...
<tr>
    ...
    <td>Output only. Geographical location of the destination. (id: GeoLocation)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Output only. The monitoring status of the WebPath. (MONITORING_STATUS_UNSPECIFIED, MONITORING, POLICY_MISMATCH, MONITORING_POINT_OFFLINE, DISABLED)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Output only. The workflow type of the WebPath. (WORKFLOW_TYPE_UNSPECIFIED, BROWSER, HTTP)</td>
</tr>
</tbody>
</table>
</TabItem>
