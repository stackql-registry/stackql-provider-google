...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="network_peerings" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Required. The type of the network to peer with the VMware Engine network. (PEER_NETWORK_TYPE_UNSPECIFIED, STANDARD, VMWARE_ENGINE_NETWORK, PRIVATE_SERVICES_ACCESS, NETAPP_CLOUD_VOLUMES, THIRD_PARTY_SERVICE, DELL_POWERSCALE, GOOGLE_CLOUD_NETAPP_VOLUMES, GOOGLE_CLOUD_FILESTORE_INSTANCES)</td>
</tr>
<tr>
    <td><CopyableCode code="state" /></td>
    <td><code>string</code></td>
    <td>Output only. State of the network peering. This field has a value of 'ACTIVE' when there's a matching configuration in the peer network. New values may be added to this enum when appropriate. (STATE_UNSPECIFIED, INACTIVE, ACTIVE, CREATING, DELETING)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a></td>
    <td><a href="#parameter-networkPeeringId"><code>networkPeeringId</code></a>, <a href="#parameter-requestId"><code>requestId</code></a>, <a href="#parameter-validateOnly"><code>validateOnly</code></a></td>
