...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="instances_iam_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="google.run.instances_iam_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Gets the IAM Access Control policy currently in effect for the given Instance. This result does not include any inherited policies.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-projectsId"><code>projectsId</code></a>, <a href="#parameter-locationsId"><code>locationsId</code></a>, <a href="#parameter-instancesId"><code>instancesId</code></a></td>
    <td></td>
    <td>Sets the IAM Access control policy for the specified Instance. Overwrites any existing policy.</td>
</tr>
<tr>
...
members,
role
FROM google.run.instances_iam_policies
...
```sql
REPLACE google.run.instances_iam_policies
SET 
data__policy = '{{ policy }}',
...
```sql
EXEC google.run.instances_iam_policies.test_iam_permissions 
@projectsId='{{ projectsId }}' --required, 
