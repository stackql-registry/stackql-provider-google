...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="rollout_kinds" /></td></tr>
...
<tr>
    <td><CopyableCode code="unitUpdatePacing" /></td>
    <td><code>object</code></td>
    <td>Optional. Settings for controlling the pacing of rollouts i.e. the number of units to be rolled out in parallel in a region. (id: UnitUpdatePacing)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Optional. The config for updating the unit kind. By default, the unit kind will be updated on the rollout start. (UPDATE_UNIT_KIND_STRATEGY_UNSPECIFIED, UPDATE_UNIT_KIND_STRATEGY_ON_START, UPDATE_UNIT_KIND_STRATEGY_NEVER)</td>
</tr>
</tbody>
</table>
</TabItem>
