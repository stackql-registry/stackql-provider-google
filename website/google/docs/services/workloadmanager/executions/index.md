...
<tr>
    ...
    <td><code>string</code></td>
    <td>Optional. Engine. (ENGINE_UNSPECIFIED, ENGINE_SCANNER, V2)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Type which represents whether the execution executed directly by user or scheduled according to the `Evaluation.schedule` field. (TYPE_UNSPECIFIED, ONE_TIME, SCHEDULED)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Output only. [Output only] State. (STATE_UNSPECIFIED, RUNNING, SUCCEEDED, FAILED)</td>
</tr>
</tbody>
</table>
</TabItem>
