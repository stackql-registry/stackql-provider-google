export const resourceNameOverridesByOperationId = {
    ...
    compute: {
        ...
        'compute.backendServices.getEffectiveSecurityPolicies': 'backend_services',
    },
    config: {
    ...
    dataform: {
        // 'tree' is a reserved word in the stackql parser, avoid it as a resource name
        'dataform.projects.locations.folders.deleteTree': 'folders_tree',
...
export const objectKeyByOperationId = {
    ...
    compute: {
        ...
        'compute.regionHealthCheckServices.aggregatedList': '$.items',
        'compute.regionNotificationEndpoints.aggregatedList': '$.items',
        'compute.networkFirewallPolicies.aggregatedList': '$.items',
        'compute.globalOperations.aggregatedList': '$.items',
        'compute.regionCommitments.aggregatedList': '$.items',
    },
    dataflow: {
...
export const sqlVerbOverrides = {
    ...
    compute: {
        ...
        'compute.backendServices.getEffectiveSecurityPolicies': 'exec',
    },
    config: {
